...
int main()
{
    ...
    int huevosSueltos, cajas;

    cout << "ingresar cantidad de huevos comprados: ";
    cin >> cantidadDeHuevos;

    cajas = cantidadDeHuevos / 12;
    huevosSueltos = cantidadDeHuevos % 12;

    int precioFinal = (cajas * precioCaja) + (huevosSueltos * precioSuelto);

    cout << "el precio final será de $" << precioFinal << " ya que se compraron " << cajas << " cajas y " << huevosSueltos << " huevos sueltos ";
