...
{
    int importeRetirar;
    int billete1000, billete500, billete200, billete100;

    cout << "ingrese monto a retirar: ";
    cin >> importeRetirar;

    billete1000 = importeRetirar / 1000;
    billete500 = (importeRetirar - billete1000 * 1000) / 500;
    billete200 = ((importeRetirar - billete1000 * 1000) - (billete500 * 500)) / 200;
    billete100 = ((importeRetirar - billete1000 * 1000) - (billete500 * 500) - (billete200 * 200)) / 100;

    cout << billete1000 << " billetes de 1000, " << billete500 << " billetes de 500, " << billete200 << " billetes de 200, " << billete100 << " billetes de 100. ";
    return 0;
}